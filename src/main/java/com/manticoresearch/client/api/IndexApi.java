...
public class IndexApi {
   ...
   * 
   * @see <a href="https://manual.manticoresearch.com/Updating_documents/UPDATE">Bulk table operations Documentation</a>
   */
   ...
   * 
   * @see <a href="https://manual.manticoresearch.com/Updating_documents/UPDATE">Delete a document in a table Documentation</a>
   */
   ...
   * 
   * @see <a href="https://manual.manticoresearch.com/Adding_documents_to_a_table/Adding_documents_to_a_real-time_table#Adding-documents-to-a-real-time-table">Create a new document in a table Documentation</a>
   */
   ...
   * 
   * @see <a href="https://manual.manticoresearch.com/Updating_documents/REPLACE#JSON-REPLACE">Partially replaces a document in a table Documentation</a>
   */
  public UpdateResponse partialReplace(String table, Long id, ReplaceDocumentRequest replaceDocumentRequest) throws ApiException {
    return partialReplaceWithHttpInfo(table, id, replaceDocumentRequest).getData();
  }
   ...
   * @see <a href="https://manual.manticoresearch.com/Updating_documents/REPLACE#JSON-REPLACE">Partially replaces a document in a table Documentation</a>
   */
  public ApiResponse<UpdateResponse> partialReplaceWithHttpInfo(String table, Long id, ReplaceDocumentRequest replaceDocumentRequest) throws ApiException {
    // Check required parameters
    if (table == null) {
      throw new ApiException(400, "Missing the required parameter 'table' when calling partialReplace");
    }
    if (id == null) {
    ...
    // Path parameters
    String localVarPath = "/{table}/_update/{id}"
   ...
   * 
   * @see <a href="https://manual.manticoresearch.com/Adding_documents_to_a_table/Adding_documents_to_a_real-time_table#Adding-documents-to-a-real-time-table">Replace new document in a table Documentation</a>
   */
   ...
   * 
   * @see <a href="https://manual.manticoresearch.com/Updating_documents/UPDATE">Update a document in a table Documentation</a>
   */
